...
//
// This version uses the same technique to generate the DShot signal
// but tracks a list of instances (via linked-list) so they are round-robin'ed
// allowing any number of pins to have the DShot capability instead of just one
// this is only required on the C3 variant of ESP32, not the classic ESP32
//
